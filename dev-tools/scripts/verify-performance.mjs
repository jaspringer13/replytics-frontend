...
// Check if DashboardOverview is updated
const dashboardPath = join(process.cwd(), 'components/dashboard/DashboardOverview.tsx');
if (existsSync(dashboardPath)) {
  console.log('✅ DashboardOverview integration exists');
} else {
  console.error('❌ DashboardOverview not found');
  process.exit(1);
}
